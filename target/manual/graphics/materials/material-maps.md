...
| Address Mode U / V | <p></p><br>Defines how (u,v) coordinates are addressed</br> <p></p><br> **Wrap**: Tiles (u,v) at integer junctions. For example, if u ranges from 0.0 to 3.0, the texture repeats three times on the U axis</br> <p></p><br>**Mirror**: Flips (u,v) at integer junctions. For example, if u ranges from 0.0 to 1.0, the texture is displayed as expected; but from 1.0 to 2.0, the texture is mirrored </br> <p></p><br> **Clamp**: Clamps (u,v) to the range (0.0, 1.0)</br> |
